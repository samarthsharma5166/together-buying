...
export function SavingsCalculator() {
  ...
  return (
    <div className="rounded-[1.7rem] bg-white p-5 premium-border md:p-6">
      <div className="mb-4"><p className="text-xs font-black uppercase tracking-[0.22em] text-[#e34b32]">Calculate Savings</p><h3 className="font-display text-3xl font-black text-[#111111]">Calculate how much can you save?</h3></div>
