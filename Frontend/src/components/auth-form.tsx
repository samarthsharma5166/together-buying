    ...
    <form action={submit} className="mx-auto grid max-w-md gap-4 rounded-[2.2rem] bg-white p-6 premium-border md:p-8">
      ...
      {mode === "register" && (
        <div className="grid grid-cols-2 gap-3">
          <input name="firstName" required placeholder="First name" className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3 outline-none transition focus:border-[#e34b32] focus:bg-white" />
          <input name="lastName" required placeholder="Last name" className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3 outline-none transition focus:border-[#e34b32] focus:bg-white" />
        </div>
      )}
      ...
      {mode === "login" ? (
        ...
        <>
          <input name="email" type="email" required placeholder="Email Address" className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3 outline-none transition focus:border-[#e34b32] focus:bg-white" />
          <input name="phone" type="tel" required pattern="[0-9]{10}" title="Please enter a 10 digit mobile number" placeholder="Phone Number (10 digits)" className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3 outline-none transition focus:border-[#e34b32] focus:bg-white" />
        </>
      )}
